...
> This repository is archived and only covers Jupyter React up-to version 0.0.10. Please go to the main [Jupyter React](https://github.com/datalayer/jupyter-react) repository for updated examples.
